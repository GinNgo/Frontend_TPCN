...
@Component({
  selector: 'app-combobox-brand',
  templateUrl: './combobox-brand.component.html',
  styleUrls: ['./combobox-brand.component.scss'],
})
export class ComboboxBrandComponent implements OnInit {
  @Input()
  list: any[] = [];
  ...
  addBrandName(input: string) {
    this.BrandName.emit(input);
  }
}
