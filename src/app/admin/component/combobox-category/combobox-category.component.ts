...
@Component({
  selector: 'app-combobox-category',
  templateUrl: './combobox-category.component.html',
  styleUrls: ['./combobox-category.component.scss'],
})
export class ComboboxCategoryComponent implements OnInit {
  @Input()
  list: any[] = [];
  @Output() CatName = new EventEmitter<string>();
  lists: string[] = [];
  ...
  addCatName(input: string) {
    input = input.substring(input.lastIndexOf('>') + 1);
    this.CatName.emit(input);
  }
}
